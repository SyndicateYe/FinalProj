...
public class CameraActivity extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    public static final int IMAGE_PICK_CODE0 = 999;
    public static final int IMAGE_PICK_CODE = 1000;
    public static final int PERMISSION_CODE = 1001;

    public Bitmap targetImage;
    public Bitmap cutImage;
    public ArrayList<Point2> cutPoints;
    public int[][] mask;
    public int imageX;
    public int imageY;
    public boolean useMixedGradients;

    // public static Bitmap finalImage;
    public static Bitmap originalImage1;
    public static Bitmap originalImage2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // VIEWS
        sImageView = (ImageView) findViewById(R.id.ViewOrigin_m);
        tImageView = (ImageView) findViewById(R.id.ViewHisteq_t);
        ...
        // Set up button for masking: id: maskingButton
        Confirm = (Button) findViewById(R.id.Confirm);
        Confirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CameraActivity.this, PossionEdit.class));
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(resultCode == RESULT_OK){
            ...
            if(requestCode == IMAGE_PICK_CODE) {
                sImageView.setImageURI(data.getData());
                sImageView.buildDrawingCache();
                originalImage1 = sImageView.getDrawingCache();

            }
            if(requestCode == IMAGE_PICK_CODE0) {
                tImageView.setImageURI(data.getData());
                tImageView.buildDrawingCache();
                originalImage2 = tImageView.getDrawingCache();
